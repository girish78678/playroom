      ...
      <main className="ROP">
        ...
        <div className="new-events--2">
          ...
          <div className=" event-play-section event-play-section--2">
            ...
            <p>
            Insolens elaboraret eum no. Persius persecuti sea, quo ad adhuc animals honestatis modus congue unum alienum sed.
            </p>
            <div className="fun--play--flexbox">
    <div className="fun--play-item">
        <div className="play-feat-img">
<img src="images/pricing-plans/feature-1.png" alt="features image" />
        </div>
    ...
    <div className="fun--play-item">
        <div className="play-feat-img">
        <img src="images/pricing-plans/feature-2.png" alt="features image" />
        </div>
        <div className="play-feat-text">
    ...
    <div className="fun--play-item">
        <div className="play-feat-img">
        <img src="images/pricing-plans/feature-3.png" alt="features image" />
        </div>
        <div className="play-feat-text">
  ...
  <div className="qodef-pricing-plans pricing-plans--2">
       <p> <span className="sub-heading">Welcome Idea</span></p>
        <h1><span className="green">Events</span> <span className="second-color">For</span> <span className="third-color">May</span></h1>
  ...
  <button>Buy Now</button>
          ...
          <div className="pricing-item pricing-item--2 pricing-item-3">
        <div className="pricing-image">
        <img src="images/pricing-plans/pricing.png" alt="your-image-description"/>
        <div className="pricing-image-text">
          <h2>326$</h2></div> 
          </div>
  <h2>B-day Party</h2>

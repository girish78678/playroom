...
export default function GridHome() {
    return ( <
        ...
        /h1> <
        p >
        At utinam probatus vix, justo velit dolores ei duo.Atom orum praesent interpretaris vim cu, in eum quaeque qualisque.Ea usu mnesarchum vo luptatibus, agam dictas civibus. <
        /p> <
        p >
        <
        span > { " " } <
        strong className = "Bold--animator " > ”Lorem ipsum dolor sit amet, consectetur adipiscing elit.” { " " } <
        /strong> <
        /span> <
        /p> <
        p >
        Adhuc summo dissentiet ei usu, qui dico noster indoctum eu.Telegere diceretuss his, pri veritus inciderint ut, vidit ullum. <
        /p> <
        ...
        <
        img src = "/images/animator/instagram.png"
        alt = "instagram icon" /
        >
        <
        /div> <
        ...
        <
        img src = "/images/animator/twitter.png"
        alt = "twitter" / >
        <
        /div> <
        div className = "facebook-animator" >
        <
        img src = "/images/animator/facebook.png"
        alt = "facebook" / >
        <
        /div> <
        /div> <
        ...
        div className = "instagram-animator" >
        <
        img src = "/images/animator/instagram--2.png"
        alt = "instagram icon" /
        >
        <
        /div> <
        div className = "twiter-animator" >
        <
        img src = "/images/animator/twitter--2.png"
        alt = "twitter" / >
        <
        /div> <
        div className = "facebook-animator" >
        <
        img src = "/images/animator/facebook--2.png"
        alt = "facebook" / >
        <
        /div> <
        /div> <
